...
const authedMenu = (
  <div className="flex flex-col gap-2">
    ...
    <button
      ...
      className={`${dangerBtn} w-full justify-center`}
    >
      Log Out
    </button>
  </div>
...
>
  <div className="shrink-0 transform -translate-x-4 -translate-y-px">
    <a
      href="/"
      className="block rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-[--color-accent-500]"
    >
      <img
  ...
  {/* Desktop: perfectly centered search bar */}
  ...
  {/* Right: Hamburger Toggle (now locked to right edge) */}
  ...
  >
    {loggedIn && (
      <div className="px-2 pb-2 mb-2 border-b border-black/10 text-sm text-[--color-text]">
